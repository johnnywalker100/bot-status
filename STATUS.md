...
| | |
|---|---|
| **Equity** | **1.0046** (+0.46% since start) |
| Peak / drawdown | 1.0572 / -4.98% |
| Ticks recorded | 651 |
| Last tick | 2026-08-19T19:08:52.957431+00:00 (-0.2202%) |
| Risk rails | normal (dd -5.0%); blind 2.1h -> 50% size on resume |
| Data source | okx (bar 2026-08-19 18:00:00+00:00) |
| Gross leverage | 1.57x |
| Weeks tracked | 4 |
| Average week | +0.17% |
| Weeks ≥ +3% | 25% |
| Best / worst week | +3.03% / -2.13% |
