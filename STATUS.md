...
| | |
|---|---|
| **Equity** | **0.9829** (-1.71% since start) |
| Peak / drawdown | 1.0572 / -7.03% |
| Ticks recorded | 658 |
| Last tick | 2026-08-20T02:10:21.639427+00:00 (-0.0399%) |
| Risk rails | normal (dd -7.0%); blind 2.2h -> 50% size on resume |
| Data source | okx (bar 2026-08-20 01:00:00+00:00) |
| Gross leverage | 1.52x |
| Weeks tracked | 4 |
| Average week | -0.36% |
| Weeks ≥ +3% | 25% |
| Best / worst week | +3.03% / -4.24% |
